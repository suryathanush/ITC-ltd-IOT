...
$(window).on("load", function () {
    ...
    $("#divTimeIntervalLabel").html("Time interval is " + timeIntervalForDataApi + " minutes. Please change if you want...");
    document.getElementById("rngTimeInterval").oninput = function () {
        $("#divTimeIntervalLabel").html("Time interval is " + this.value + " minutes. Please change if you want...");
    };
